                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" id="section_id">
                                    <!-- placeholder -->
                                    <option value="{{$invoice->sec_id->id}}" selected disabled>{{$invoice->sec_id->section_name}} </option>
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control">
                                    <option value="{{$invoice->product}}" selected disabled>{{$invoice->prod_id->product_name}}</option>
                                </select>
                            </div>
            ...
            $('#section_id').on('change', function () {
                ...
                if (sectionId) {
                    $.ajax({
                        ...
                        success: function (data) {
                            $('#product').empty();
                            $('#product').append('<option value="" selected disabled>حدد المنتج</option>');
                            $.each(data, function (key, value) {
